    ...
    <div className="flex flex-col items-center justify-between bg-white">
      <div className={` bg-cover flex mt-20`}>
        <div className="container  h-full px-5  xl:px-20  flex flex-col justify-center  ">
          <h2 className="lg:text-8xl  text-3xl font-ITCAVANTGARDESTDBold font-extrabold text-primary">
            FERTILIZERS:
          </h2>
          ...
          <div className="flex flex-row flex-wrap gap-16">
            ...
            <div className="w-full  lg:flex-[2] flex flex-col">
              ...
              <ul className="text-2xl font-ITCAVANTGARDESTDBold text-gray-700  font-semibold mt-7 tracking-[0.3rem] flex flex-col gap-8">
